<div class="modal fade" id="editMate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      <div class="modal-header btn-comita text-white">
        ...
        <div class="modal-body">
            <form method="POST" action="{{ route('admin.materiales.update', 'test') }}" class="bg-white shadow rounded py-3 px-4">
				@method('PUT') @csrf
				<div class="form-group">
		            ...
		            <input class="form-control bg-light shadow-sm {{ $errors->has('nombre') ? ' is-invalid' : 'border-0' }}"
		                    ...
		                    placeholder="Ingrese el nombre del material" value="{{ old('nombre') }}" >
